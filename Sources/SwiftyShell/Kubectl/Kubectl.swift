...
public struct Kubectl: RunnableCommandFamily {
    ...
    public func contextName(_ name: String) -> Self { copy(contextName: name) }
    ...
    public func command() -> Command {
        ...
        appendOption("--context", state.contextName, to: &arguments)
...
private struct State: Sendable {
    ...
    let subcommand: String; let kubeconfigPath: String?; let contextName: String?; let namespaceName: String?;
    let outputFormat: String?
    let filenames: [String]; let selectorValue: String?; let containerName: String?; let allNamespacesEnabled: Bool;
    let extraArguments: [String]; let resources: [String]
    init(
        ...
        self.subcommand = subcommand; self.kubeconfigPath = kubeconfigPath; self.contextName = contextName;
        self.namespaceName = namespaceName; self.outputFormat = outputFormat; self.filenames = filenames;
        self.selectorValue = selectorValue; self.containerName = containerName;
        self.allNamespacesEnabled = allNamespacesEnabled; self.extraArguments = extraArguments;
